...
const PostCardProp = { "id": 1, "verb": "posted", "object": "Post:1", "actor": "Bobby L. Booker", "created_at": "2018-03-28T16:07:13.840Z", "updated_at": "2018-03-28T16:07:13.840Z" }
const ShareCardProp = { "id": 20, "verb": "shared", "object": "Share:10", "actor": "Yole Fonseca Otero", "created_at": "2018-03-28T16:07:14.082Z", "updated_at": "2018-03-28T16:07:14.082Z" }
...
it('Test post card with post', () => {
    const postedFeedCardRendered = shallow(<DisplayPostCard
        feed={PostCardProp}
...
it('Test share card with url', () => {
    const sharedFeedCardRendered = shallow(<DisplaySharedCard
        feed={ShareCardProp}
        cardsSharedUrl={"https://www.flipgive.com/"}
        showCardsSharedUrlFlag={true}
        showLoader={false} />);
    expect(sharedFeedCardRendered.contains("https://www.flipgive.com/")).toEqual(true);
});
